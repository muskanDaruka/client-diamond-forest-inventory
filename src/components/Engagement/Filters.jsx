        ...
        <>
            <div className='grid xl:grid-cols-4 gap-6 m-4 font-montserrat'>
                ...
                <div className="text-center mt-6 lg:hidden">
                    <button type="submit" className="bg-gray-50 px-6 py-2 xl:text-xl text-md font-[200px] text-white font-montserrat ">View Result</button>
                </div>
            </div>
            <div className="text-center m-6  hidden lg:block">
                <button type="submit" className="bg-gray-500 px-6 py-2 xl:text-xl text-md font-[200px] text-white font-montserrat ">View Result</button>
            </div>
        </>
    );
}
